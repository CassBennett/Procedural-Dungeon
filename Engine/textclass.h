...
public:
	...
	bool RenderInstructions(ID3D11DeviceContext*, FontShaderClass*, D3DXMATRIX, D3DXMATRIX);
...
private:
	...
	SentenceType *m_sentence11, *m_sentence12, *m_sentence13, *m_sentence14;
	// Instructions sentences
	SentenceType *m_iSentence1, *m_iSentence2, *m_iSentence3, *m_iSentence4, *m_iSentence5;
	SentenceType *m_iSentence6, *m_iSentence7, *m_iSentence8, *m_iSentence9, *m_iSentence10;
	SentenceType *m_iSentence11;
};
